                ...
                <div className={"mx-4 flex w-sm space-x-1 self-center md:w-xl lg:w-2xl"}>
                    {[...Array.from({ length: count })].map((_, idx) => (
                        <div
                            ...
                            key={idx}
                            className={`h-1 w-full min-w-0 cursor-pointer bg-white transition-all duration-300 ${idx === current - 1 ? "opacity-100" : "opacity-50"}`}
                        ...
                        <CarouselContent className={"text-white"}>
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                    ...
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>1. Map</div>
                                        <div className={"text-center text-xl"}>
                                            Màn chơi được chọn cho Mini-Tournament là
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>H14-4</span>
                                        </div>
                                    </CardFooter>
                                </Card>
                            </CarouselItem>
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                    ...
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>2. Squad</div>
                                        <div className={"text-center text-xl"}>
                                            Bạn được phép mang tối đa
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>08 Operator</span>
                                            {", "}
                                            bao gồm:
                                            {" "}
                                            <span className={"font-extrabold text-green-300"}>07 Operator tự chọn</span>
                                            {" "}
                                            và
                                            {" "}
                                            <span className={"font-extrabold text-red-300"}>01 operator bắt buộc</span>
                                            {" "}
                                            là
                                            {" "}
                                            <span className={"font-extrabold italic underline"}>Amiya (Medic)</span>
                                        </div>
                                    </CardFooter>
                                </Card>
                            </CarouselItem>
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                    ...
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>3. In-Game</div>
                                        <div className={"text-center text-xl"}>
                                            Bạn được phép
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>Leak</span>
                                            {", "}
                                            <span className={"font-extrabold text-amber-300"}>Tạm dừng Game</span>
                                            {" "}
                                            và
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>Điều chỉnh Tốc độ</span>
                                            {" "}
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                    <CardContent className={"flex h-72 flex-col items-center justify-evenly"}>
                                        ...
                                        <div className={"text-md text-center font-extralight text-white italic"}>
                                            (Staff sẽ báo hiệu khi bạn còn
                                            {" "}
                                            <span className={"font-extrabold text-green-300"}>50% thời gian</span>
                                            {" "}
                                            và
                                            {" "}
                                            <span className={"font-extrabold text-red-300"}>01 phút</span>
                                            {" "}
                                            để hoàn thành)
                                        </div>
                                    </CardContent>
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>4. Giới hạn thời gian</div>
                                        <div className={"text-center text-xl"}>
                                            Bạn sẽ có
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>06 phút</span>
                                            {" "}
                                            để hoàn thành màn chạy, bao gồm
                                            {" "}
                                            <span className={"font-extrabold text-cyan-300"}>02 phút</span>
                                            {" "}
                                            chọn operator.
                                        </div>
                                    </CardFooter>
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                        ...
                                        <Card className={"items-center border-none bg-transparent"}>
                                            <CardContent className={"items-center justify-center"}>
                                                <Image
                                                    ...
                                                    width={100}
                                                />
                                                <Ban className={"absolute translate-x-4 -translate-y-20"} color={"#ff0000"} size={64} />
                                            </CardContent>
                                            <CardFooter className={"text-center font-bold text-white"}>
                                                (Specialist ban)
                                            </CardFooter>
                                    ...
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>5. Giới hạn màn chơi #1</div>
                                        <div className={"text-center text-xl"}>
                                            Bạn chỉ được dùng tối đa
                                            {" "}
                                            <span className={"font-extrabold text-red-300"}>04 Roadblock</span>
                                            {" "}
                                            và
                                            {" "}
                                            <span className={"font-extrabold text-red-300"}>không được dùng Specialist</span>
                                            .
                                        </div>
                                    </CardFooter>
                                </Card>
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                    <CardContent className={"flex h-72 flex-wrap items-center justify-center p-0!"}>
                                        {
                                            [
                                                ...
                                                <Card key={v.num} className={"items-center border-none bg-transparent"}>
                                                    <CardContent className={"flex items-center justify-center"}>
                                                        <Image
                                                            alt={"map-info"}
                                    ...
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>6. Giới hạn màn chơi #2</div>
                                        <div className={"text-center text-xl"}>
                                            <span className={"font-extrabold text-red-300"}>05 Operator trên sẽ bị BAN</span>
                                            {" "}
                                            và
                                            {" "}
                                            <span className={"font-extrabold text-green-300"}>06 Operator khác do các bạn chọn</span>
                                            {", "}
                                            nâng tổng số Operator bị ban lên con số
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>11 Operator</span>
                                            .
                                        </div>
                                    </CardFooter>
                                </Card>
                            ...
                            <CarouselItem className={"h-128"}>
                                <Card className={"border-none bg-transparent"}>
                                    ...
                                    <CardFooter className={"flex flex-col space-y-2 text-white"}>
                                        <div className={"text-center text-4xl font-extrabold"}>7. Quy chế tính điểm</div>
                                        <div className={"text-center text-xl"}>
                                            BTC sẽ sử dụng quy tắc tính điểm
                                            {" "}
                                            <span className={"font-extrabold text-amber-300"}>Score Attack</span>
                                            {" "}
                                            dựa trên các yếu tố được định trước.
                                        </div>
                                        <Button asChild>
                                            <Link className={"border hover:invert"} href={"/contest/scoring"}>Bạn có thể xem cụ thể tại đây.</Link>
                                        </Button>
                                    </CardFooter>
                                </Card>
                            </CarouselItem>
