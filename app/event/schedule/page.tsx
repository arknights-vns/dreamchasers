    ...
    return (
        <div className={"h-visible bg-vns flex flex-col"}>
            ...
            <div className={"mx-14 flex flex-col items-center justify-center"}>
                ...
                <Timeline className={"mx-auto mt-32 hidden md:flex"} orientation={"horizontal"} value={progression}>
                ...
                <Timeline className={"mt-8 flex max-h-[30svh] md:hidden"} value={progression}>
                    {items.map((item, index) => (
                        <TimelineItem
                            key={item.title}
